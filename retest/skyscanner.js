...
page.open('http://www.skyscanner.de/transport/fluge/duss/pmi/161121?adults=2')
//page.open('http://www.skyscanner.de/transport/fluge/pmi/duss/160426?adults=8')
    ...
    .then(function() {
        ...
        sendEvent('click', 'button.apd-bar-button');
        return page.waitForDomElement("span.wc-button-text");
        ...
        return page.evaluate(function(){
            return new Promise(function (accept) {
                var interval =  setInterval(function() {
                    var test = !$('div.day-search-message').is(':visible');
                    console.log(test);
